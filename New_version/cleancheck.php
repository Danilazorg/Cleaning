        ...
        <table id="tablepress-16" class="tablepress tablepress-id-16">
                                                    ...
                                                    <tbody>
                                                       ...
                                                       $link->set_charset("utf8");
									                         ...
									                         $link->set_charset("utf8");
									                         $result = $link->query("SELECT id, name, phone, address, quantity, comment, done FROM cleaning");
									                   ...
									                   echo '
                                                        <tr class="row-2 even">
                                                            ...
                                                            <button name="submit">Отправить на исполнение</button>
                                						...
                                						if (isset($_POST['itemId'])) {
                                                            $id = $_POST['itemId'];
                                                            $result = $link->query("UPDATE cleaning SET done = 'На исполнении' WHERE id=${id}");
                                                        }
